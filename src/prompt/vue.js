...
const variables = [
  'silent', 'optionMergeStrategies', 'devtools', 'errorHandler', 'ignoredElements', 'keyCodes',
  ...
  'parent', 'mixins', 'name', 'extends', 'delimiters', 'functional',
  '$data', '$el', '$options', '$parent', '$root', '$children', '$slots', '$scopedSlots', '$refs', '$isServer',
  '$watch', '$set', '$delete',
  '$on', '$once', '$off', '$emit',
